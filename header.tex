...
\lstdefinelanguage{Ocelet}[]{Java}{
        morekeywords={entity, service, scenario, property},
        sensitive=false
}

\lstdefinelanguage{pseudo}[]{Java}{
        morekeywords={each},
        sensitive=false
}

\lstdefinelanguage{firstDSL}[]{Java}{
        morekeywords={Model, Container, FlowIN, TO, FlowOUT, Conjunction, variable, from},
        sensitive=false
}

\lstdefinelanguage{secondDSL}[]{Java}{
        morekeywords={describe, depends, on, as, run, simulation, from, init, end},
        sensitive=false
}
