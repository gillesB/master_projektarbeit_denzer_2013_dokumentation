...
\subsection{Domain-speciﬁc data structures}
\par
Domain-speciﬁc data structures can be used by the modeler to semantically describe the following elements in the DSL.
\begin{itemize}
