...
\section{Priorities}
\par
After the first step of information gathering the group decided to organize these features by priorities and practicability to proof which goals are achievable in the given time.  
