...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{pics/toolchain/toolchain.png}
	\caption{modeling workflow \label{fig:modeling_workflow}}	
\end{figure}
